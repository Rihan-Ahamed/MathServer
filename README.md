...
.box {
    ...
    border: thick dashed rgb(71, 187, 102);
    width: 500px;
    min-height: 300px;
    font-size: 20px;
    background-color: rgb(167, 85, 222);
}
.formelt {
    color: black;
    text-align: center;
...
![alt text](<Screenshot 2025-05-01 184528.png>)

## HOMEPAGE:
![alt text](<Screenshot 2025-05-01 184410.png>)
